...
# -------- الاتصال بقاعدة البيانات عبر Railway Postgres ----------
...
async def handle_message(update: Update, context: ContextTypes.DEFAULT_TYPE):
    ...
    if text == "💰 Earn":
        ...
        conn.commit()
        await update.message.reply_text(f"Daily check-in successful! You earned {MICRO_TOKENS_CHECKIN} Micro-Tokens.", reply_markup=WELCOME_KEYBOARD)
