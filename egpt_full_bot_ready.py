...
# -------- ضع هنا التوكن الجديد للبوت --------
TOKEN = "PUT_YOUR_NEW_BOT_API_HERE"  # ضع التوكن الجديد هنا

# -------- ضع هنا اسم البوت على تيليجرام --------
BOT_USERNAME = "EGPTCOINSBot"  # بدون @

ADMIN_IDS = [123456789]  # ضع Telegram ID الخاص بك كأدمين
